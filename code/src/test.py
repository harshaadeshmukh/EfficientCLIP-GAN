...
def parse_args():
    ...
    parser.add_argument('--pretrained_model_path', type=str, default='model',
                        help='the destination of the model for training')
...
def main(args):
    ...
    # Set attributes for pretrained model path and multiple GPUs
    state_path = args.pretrained_model_path
    multi_gpus = args.multi_gpus

    # Load the preprocessed data of the birds from NPZ
    ...
    # Calculate the the FID and CLIP score
...
if __name__ == "__main__":
    ...
    # Setting up the training environment for distributed training on GPUs
    if args.cuda:
        if args.multi_gpus:
